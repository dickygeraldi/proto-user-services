...
var (
	...
	pattern_UserServices_LoginAccount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "user-services", "login-account-harvesting"}, "", runtime.AssumeColonVerbOpt(true)))
